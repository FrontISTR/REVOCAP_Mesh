...
#ifdef _MSC_VER
#pragma warning(push)
#pragma warning(disable:4100) // égÇÌÇ»Ç¢à¯êîÇ™Ç†Ç¡ÇƒÇ‡åxçêÇèoÇ≥Ç»Ç¢ for VC
#endif

#ifdef __INTEL_COMPILER
#pragma warning(push)
#pragma warning(disable:869) // égÇÌÇ»Ç¢à¯êîÇ™Ç†Ç¡ÇƒÇ‡åxçêÇèoÇ≥Ç»Ç¢ for intel
#endif
...
kmb::Point3DContainerVect::_iteratorVect::operator++(void)
{
	...
	if( this->index < static_cast<int>( this->vect->points.size() ) ){
		...
		// delete this ÇÕÇµÇ»Ç¢ÅB
		// delete Ç∑ÇÈÇÃÇÕ wrapper iterator
		return NULL;
	}
}

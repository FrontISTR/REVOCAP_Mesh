...
// óÒÇ≤Ç∆Ç…ê¨ï™ÇÃê‚ëŒílÇÃòaÇåvéZÇµÇΩÇ§ÇøÇ≈ÇªÇÃç≈ëÂÇÃÇ‡ÇÃ
double
...
// çsÇ≤Ç∆Ç…ê¨ï™ÇÃê‚ëŒílÇÃòaÇåvéZÇµÇΩÇ§ÇøÇ≈ÇªÇÃç≈ëÂÇÃÇ‡ÇÃ
double
...
kmb::SquareMatrix::solve(const kmb::ColumnVector &b, kmb::ColumnVector &x) const
{
	...
	if(size == 1){
		...
		for(int j=0;j<size;++j){
			// j Ç©ÇÁ size-1 Ç≈ê‚ëŒílç≈ëÂÇíTÇ∑
			int ind = -1;
			double m = 0.0;

...
kmb::FaceBucketArea::setAutoBucketSize(void)
{
	...
	// ”–”Â‚Ìê‡‚ÉŒú‚Ý‚ªo‚é‚æ‚¤‚É‚·‚é‚½‚ß
	bbox.expandDiameter( 1.5 );
	this->setRegion( bbox );

	// ˆê”Ô’Z‚¢‚Æ‚±‚ë‚ð 1 ‚Æ‚µ‚½‚Æ‚«‚Ì bucket ‚ÌŒÂ”‚ð‹‚ß‚é
...
// ‚±‚ê‚ðŽg‚¤‚ÆŽOŠpŒ`‚É•ªŠ„‚µ‚Ä•¡”“o˜^‚³‚ê‚Ä‚µ‚Ü‚¤‚±‚Æ‚É’ˆÓ
// ‚·‚È‚í‚¿AFace ‚Æ Grid ‚ÌŒð·‚ªŽlŠpŒ`‚È‚ç‚ÎŽOŠpŒ`‚É•ªŠ„‚µ‚Ä2‚Â“o˜^‚³‚ê‚Ä‚µ‚Ü‚¤B
int

...
public:
	...
	// ï”ÇÃåä∑
	// orientation=true  abcd Ç∆ befc Ç©ÇÁ abed Ç∆ efcd Ç…ïœä∑Ç∑ÇÈÅiã§í ï”Çèáï˚å¸Ç…Ç∏ÇÁÇ∑Åj
	// orientation=false abcd Ç∆ befc Ç©ÇÁ abef Ç∆ afcd Ç…ïœä∑Ç∑ÇÈÅiã§í ï”Çãtï˚å¸Ç…Ç∏ÇÁÇ∑Åj
	static bool edgeSwap(kmb::ElementBase &quad0,kmb::ElementBase &quad1,bool orientation=true);
	// éläpå`Ç…ì¡âªÇµÇΩàÍívîªíË
	// 1 : àÍív -1 : ãtå¸Ç´ 0 : ÇªÇÃëº

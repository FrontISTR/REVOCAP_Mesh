...
{
	// p0 + t1(p1-p0) Ç∆ q0 + t2(q1-q0) ÇÃãóó£ÇÃç≈è¨âª
	// u0 + t1*u1 + t2*u2 ÇÃí∑Ç≥ÇÃç≈è¨âª
...
{
	// t1 = s t2 = t[0] t3 = t[1]
	// p0 + t1(p1-p0) Ç∆ q0 + t2(q1-q0) + t3(q2-q0) Ç∆ ÇÃãóó£ÇÃç≈è¨âª
	// u0 + t1*u1 + t2*u2 + t3*u3 ÇÃí∑Ç≥ÇÃç≈è¨âª
	kmb::Vector3D u0(p0,q0);
	kmb::Vector3D u1(p1,p0);
	kmb::Vector3D u2(q0,q1);
